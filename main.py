...
__CHANNEL_USERNAME__ = "@Gzstoresofc"
__GROUP_USERNAME__   = "77 99159-0855"
...
def banner(console):
    ...
    brand_name =  "ATENCAO PARA USAR A FERRAMENTA E NECESSARIO ADICIONAR CREDITOS COM O ADM GZ VENDAS."
    colors = [
